    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-2">사진첩</h1>
        ...
        {/* Upload Modal */}
        {isUploading && (
          <Card title="사진 업로드" className="mb-8">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">사진을 드래그하거나 클릭하여 업로드하세요</p>
            ...
            <div className="bg-white rounded-lg max-w-4xl max-h-full overflow-auto">
              <div className="p-6">
                ...
                <img
                  ...
                  className="w-full max-h-96 object-cover object-top rounded-lg mb-4"
                />
