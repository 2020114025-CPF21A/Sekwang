      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">성경 미니게임</h1>
            <p className="text-xl text-gray-600">재미있게 성경 지식을 테스트해보세요!</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer" onClick={() => startGame('multiple')}>
              <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="ri-question-line text-3xl text-blue-600"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">객관식 퀴즈</h3>
              <p className="text-gray-600 mb-6">4개의 선택지 중 정답을 골라보세요</p>
              <Button onClick={() => startGame('multiple')}>게임 시작</Button>
            </Card>

            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer" onClick={() => startGame('ox')}>
              <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="ri-checkbox-circle-line text-3xl text-green-600"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">OX 퀴즈</h3>
              <p className="text-gray-600 mb-6">참 또는 거짓을 선택하세요</p>
              <Button onClick={() => startGame('ox')} variant="success">게임 시작</Button>
            </Card>

            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer" onClick={() => startGame('speed')}>
              <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="ri-flashlight-line text-3xl text-orange-600"></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">스피드 퀴즈</h3>
              <p className="text-gray-600 mb-6">빠르게 단답형으로 답하세요</p>
              <Button onClick={() => startGame('speed')} className="bg-orange-600 hover:bg-orange-700">게임 시작</Button>
            </Card>
          </div>

          {/* Game Records */}
          <Card title="최근 게임 기록" className="mt-12">
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <div>
                  <span className="font-medium text-gray-800">객관식 퀴즈</span>
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <div>
                  <span className="font-medium text-gray-800">OX 퀴즈</span>
              ...
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <div>
                  <span className="font-medium text-gray-800">스피드 퀴즈</span>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">점수: {score}점</p>
          </div>
          <div className="text-right">
            <div className={`text-3xl font-bold ${timeLeft <= 3 ? 'text-red-600' : 'text-blue-600'}`}>
              {timeLeft}
            </div>
            <Button onClick={endGame} variant="danger" size="sm">게임 종료</Button>
          </div>
        </div>
          ...
          {gameMode === 'speed' && (
            <div className="text-center">
              <input
                ...
                className="w-full max-w-md px-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center"
                onKeyPress={(e) => {
                  if (e.key === 'Enter') {
