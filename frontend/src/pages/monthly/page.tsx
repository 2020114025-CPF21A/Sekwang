    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">월간 출석표</h1>
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm pr-8"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card title={`${selectedYear}년 ${months[selectedMonth]} 출석표`}>
        ...
        {/* Yearly Overview */}
        <Card title="연간 출석 현황" className="mt-8">
