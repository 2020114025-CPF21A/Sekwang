    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-2">신앙 일지</h1>
            <p className="text-gray-600">하나님과 함께한 일상을 기록해보세요</p>
          </div>
          <Button onClick={() => setIsWriting(true)} className="whitespace-nowrap">
        ...
        {isWriting && (
          <Card title="새 일지 작성" className="mb-8">
            <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {moods.map(mood => (
                      <button
                        ...
                        className={`w-10 h-10 text-2xl rounded-lg border-2 transition-colors cursor-pointer ${
              ...
              <div className="flex space-x-3">
                <Button onClick={handleWriteDiary} className="flex-1">
                  일지 저장하기
                </Button>
                <Button onClick={() => setIsWriting(false)} variant="secondary">
                  취소
                </Button>
              </div>
            </div>
        ...
        {selectedDiary ? (
          <Card>
            <div className="mb-6">
              <Button onClick={() => setSelectedDiary(null)} variant="secondary" size="sm">
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">{selectedDiary.title}</h2>
                </div>
              </div>
          ...
          <div className="space-y-6">
            {diaries.map((diary) => (
              <Card key={diary.id} className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => setSelectedDiary(diary)}>
        ...
        {/* Monthly Summary */}
        <Card title="이번 달 일지 현황" className="mt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">작성한 일지</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">연속 작성일</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-lg font-bold text-purple-600">행복</p>
              <p className="text-sm text-gray-600">이번 달 주요 기분</p>
            </div>
          </div>
        </Card>
      </div>
