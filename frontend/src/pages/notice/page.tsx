  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {isWriting && (
          <Card title="새 공지사항 작성" className="mb-8">
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                <Button onClick={handleWriteNotice} className="flex-1">
                  공지사항 등록
                </Button>
        ...
        {selectedNotice ? (
          <Card>
            <div className="mb-6">
              <Button onClick={() => setSelectedNotice(null)} variant="secondary" size="sm">
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">{selectedNotice.title}</h2>
                </div>
              </div>
